...
public class ExceptionConsts {
  ...
  public static final String INDEX_INVALID_ERROR = "You have entered an invalid index.";
  public static final String DESCRIPTION_EMPTY_ERROR = "The description of a {0} cannot be empty.";
  public static final String INDEX_EMPTY_ERROR = "The index of a {0} cannot be empty.";
